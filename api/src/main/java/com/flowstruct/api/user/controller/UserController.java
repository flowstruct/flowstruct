...
public class UserController {
  ...
  public ResponseEntity<Void> loginUser(
      @Valid @RequestBody LoginDetailsDto loginDetails, HttpServletResponse response) {
  ...
  @PostMapping
  public ResponseEntity<UserDto> createUser(@Valid @RequestBody NewUserDetailsDto details) {
    return new ResponseEntity<>(userManagementService.createUser(details), HttpStatus.OK);
  }

  @PutMapping("/{userId}")
  public ResponseEntity<UserDto> editUserDetails(
      @PathVariable long userId, @Valid @RequestBody UserDetailsDto details) {
    return new ResponseEntity<>(
        userManagementService.editUserDetails(userId, details), HttpStatus.OK);
  }

  @PutMapping("/{userId}/password")
  public ResponseEntity<Void> changeUserPassword(
      @PathVariable long userId, @Valid @RequestBody AdminPasswordResetDto passwordReset) {
  ...
  public ResponseEntity<UserDto> changeUserRole(
    ...
    return new ResponseEntity<>(
        userManagementService.changeUserRole(userId, newRole), HttpStatus.OK);
  }
